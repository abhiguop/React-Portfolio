  ...
  const sendEmail = async (e) => {
    ...
    try {
      ...
      await emailjs.sendForm(
        'service_q1wnxkd', // Your service ID
        'template_pgpzcl7', // Your template ID
        form.current,
        'tL6-c5jvO75pvJqds' // Your public API key/user ID
      );
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">ayushg8954@gmail.com</span>
              <a href="mailto:ayushg8954@gmail.com" className="contact__button" target='_blank' rel="noreferrer">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">7895785772</span>
              <a href="https://api.whatsapp.com/send?phone=+917895785772&text=Hello, More Information" className="contact__button" target='_blank' rel="noreferrer">
                Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">abhinav_g203</span>
              <a href="https://www.instagram.com/abhinav_g203/" className="contact__button" target='_blank' rel="noreferrer">
                Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            <div className="contact__form-div">
              ...
              <input type="text" name="from_name" id="name" className="contact__form-input" placeholder="Insert your name" required />
            </div>
            <div className="contact__form-div">
              <label htmlFor="email" className="contact__form-tag">Mail</label>
              <input type="email" name="from_email" id="email" className="contact__form-input" placeholder="Insert your email" required />
            </div>
            <div className="contact__form-div contact__form-area">
              <label htmlFor="message" className="contact__form-tag">Message</label>
              <textarea name="message" id="message" cols="30" rows="10" className="contact__form-input" placeholder="Write your message" required></textarea>
            </div>
